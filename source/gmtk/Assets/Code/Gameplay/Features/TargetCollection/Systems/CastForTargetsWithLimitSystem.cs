...
namespace Code.Gameplay.Features.TargetCollection.Systems
{
  public class CastForTargetsWithLimitSystem : IExecuteSystem, ITearDownSystem
  {
    ...
    public CastForTargetsWithLimitSystem(GameContext game, IPhysicsService physicsService)
    {
      ...
      _ready = game.GetGroup(GameMatcher
        .AllOf(
          ...
          GameMatcher.TargetCollectionCastPoint,
          GameMatcher.TargetCollectionLayerMask)
      );
    }
    ...
    {
      return _physicsService.CircleCastNonAlloc(entity.TargetCollectionCastPoint, radius: entity.Radius, entity.TargetCollectionLayerMask, _targetCastBuffer);
    }
