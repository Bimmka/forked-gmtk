...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.CharacterStats.EffectValue effectValue { get { return (Code.Gameplay.Features.CharacterStats.EffectValue)GetComponent(GameComponentsLookup.EffectValue); } }
    ...
    public GameEntity AddEffectValue(float newValue) {
        ...
        var component = (Code.Gameplay.Features.CharacterStats.EffectValue)CreateComponent(index, typeof(Code.Gameplay.Features.CharacterStats.EffectValue));
